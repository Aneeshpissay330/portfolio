export default function Contact() {
    return (
        ...
        //                 {/* Contact Form */}
        //                 <div id="contact-form" className="bg-white border border-gray-200 p-8">
        ...
        //                             <input
        //                                 type="text"
        //                                 className="w-full border border-gray-300 px-4 py-3 focus:border-black focus:outline-none transition-colors"
        ...
        //                         <span className="flex items-center space-x-4 text-gray-700 hover:text-black transition-colors cursor-pointer">
        ...
        //                                 <p className="text-sm text-gray-600">github.com/alexchen</p>
        //                             </div>
        //                         </span>
        //                         <span className="flex items-center space-x-4 text-gray-700 hover:text-black transition-colors cursor-pointer">
        //                             <div className="w-12 h-12 bg-gray-100 border border-gray-200 flex items-center justify-center">
